...
function Dashbord() {
    ...
    function savetemplate(e) {
        ...
        if (template_title == null || template_title == "") {
            ...
            return false;
        } else if (template_message == null || template_message == "") {
            alert("Message can't be blank");
            return false;
        } else if (color_code == null || color_code == "") {
            alert("Color code can't be blank");
            return false;
        }

        if (template_title && template_message && color_code) {
            fetch(config.APP_BASE_URL + "/template", {
                ...
                .then((responseData) => {
                    ...
                    if (responseData.status == '200') {
                        ...
                        alert("Template all ready Exits");
                        ...
                        <div class="container-fluid px-4">
                            ...
                            <form>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="template_title" autocomplete="template_title" onChange={(e) => setTitle(e.target.value)} type="text" placeholder="Enter your Question" />
                                            <label for="inputFirstName">Enter Template Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control" id="template_message" autocomplete="template_message" onChange={(e) => setMessage(e.target.value)} type="text" placeholder="Enter your Answer" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="color_code" autocomplete="color_code" onChange={(e) => setCode(e.target.value)} type="color" placeholder="Enter your Quiz Level" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <select class="form-control" id="quiz_rule" autocomplete="quiz_rule" onChange={(e) => setRule(e.target.value)}>
                                                <>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <select class="form-control" id="quiz_type" autocomplete="quiz_type" onChange={(e) => setType(e.target.value)}>
                                                <>
