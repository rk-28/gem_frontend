    ...
    function save(e)
    {
        ...
        if (question==null || question==""){  
            ...
            return false;  
                ...
                if (question && answer && std_id && templeate_id ) { 
                     ...
                     .then((responseData) => {
                       ...
                       {
                        alert("Question all ready Exits");
                         ...
                         <br></br>
                            <form>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input  class="form-control" id="question" autocomplete = "question" onChange={(e)=>setQuestion(e.target.value)} type="text" placeholder="Enter your Question" />
                                                        <label for="inputFirstName">Enter your Question</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="answer" autocomplete = "answer" onChange={(e)=>setAnswer(e.target.value)} type="text" placeholder="Enter your Answer" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                    {/* <input class="form-control" id="qes_image" autocomplete = "qes_image" onChange={(e)=>setQes_image(e.target.value)} type="file" placeholder="Enter your Quiz Level" />
                                            ...
                                            <div class="row mb-3">
                                                {/* <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="form-control" id="templeate_id" onChange={(e)=>setTempleate_id(e.target.value)}>
                                                            <option value="1">Select Template</option>
                                                            <option value="2">Prek or lower </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="form-control" hidden id="timeduration" onChange={(e)=>setTimeduration(e.target.value)}>
