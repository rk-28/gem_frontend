  ...
  const [asd, setId] = useState("");
...

        {
         ...
         function edit(e)  {
             ...
             navigate('/editquizsetup/'+e.target.id)
           }
           ...
           function croessdata(e)
           {
            setDataid(e.target.id)
                 ...
                 fetch(config.APP_BASE_URL + "/quizset/delete/"+e.target.id, {
...
function logout()
{
  ...
  return (
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <a class="navbar-brand ps-3" href="">Gems Quiz</a>
        ...
        <div id="layoutSidenav_content">
                ...
                <div class="card mb-4">
                        <div class="card-header bg-primary ">
                            <i class="fas fa-table me-1 "><button type="button" onClick={addquizsetup} class="btn btn-primary btn-xs">+ Add Quiz Block</button></i>
                        </div>
   ...
   <MaterialTable border="2px"
    icons={tableIcons}
      ...
      columns={[
        ...
        { title: 'Quiz Block Time', field: 'time_duration_in_min' },
